...
#define PRODUCT_STATUS_REG_ADDRESS			(0b1111110)
...
bool SBC_Init(void)
{
	...
	SBC_write_register.field.address = PRODUCT_STATUS_REG_ADDRESS;
	SBC_write_register.field.register_access_mode = 0u;
	...
	SBC_write_register.field.register_access_mode = 1u;
